export const legalText = {
  en: {
    common: {
      ...
      note: 'This document applies to the Contivo mobile application and the contivoapp.com website. If a translated version differs from the English version, the English version is used for interpretation to the extent permitted by law.'
    },
    privacy: {
      eyebrow: 'Legal',
      ...
      sections: [
        ...
        ['5. Shared budgets and collaboration', 'When you participate in a shared budget, your profile identity, role and permitted activity may be visible to other members of that budget. Depending on permissions, members may see transactions, categories, goals, notes, creator information and changes made by participants. Budget owners control invitations and roles. You should share a budget only with people you trust.'],
        ['6. Device data, permissions and notifications', 'Contivo may process device and app information needed for security, compatibility, synchronization and push delivery, such as app version, operating system, device token and basic diagnostic events. Camera access is used only when you choose to take a profile photo. Photo-library access may be used when you choose an existing image. Notification permission is used for reminders, invitations and shared-budget updates. Contivo does not request access to your precise location, phone contacts or microphone for the current release.'],
        ['7. Offline storage and synchronization', 'To make the application usable without a continuous internet connection, selected account, profile, budget and transaction data may be stored locally on your device. Locally created changes may be queued and synchronized with Contivo’s cloud infrastructure when a connection becomes available. Removing the app or clearing app storage may remove local copies that have not yet synchronized.'],
        ['8. Website analytics', 'The website contivoapp.com uses Google Analytics to understand aggregate website usage, such as visited pages, approximate region, device type and referral source. IP anonymization is enabled in the website configuration. Website analytics are separate from the financial content stored in the Contivo app.'],
        ['9. How and why data is used', 'Data is processed to create and secure accounts; provide app functions; save and synchronize information; support offline operation; enable shared budgets, roles and invitations; deliver notifications and service emails; generate reports; restore access; prevent abuse; troubleshoot problems; respond to requests; comply with legal obligations; and improve reliability and usability. Where applicable, processing is based on performance of the service requested by you, legitimate interests in operating and securing the service, consent for optional permissions or communications, and compliance with legal obligations.'],
        ['10. Service providers', 'Contivo uses carefully selected providers to operate the service. Supabase provides authentication, database, realtime synchronization and file-storage infrastructure. Google Firebase Cloud Messaging provides push-notification delivery. Resend may deliver account and service emails. Google Analytics measures website usage. These providers process data under their own terms and privacy safeguards and may process data in countries outside your place of residence.'],
        ['11. Sharing and disclosure', 'Contivo does not sell your personal data. Data may be disclosed to service providers only as needed to operate the service; to participants when you intentionally use shared features; when required by law or a valid authority request; to protect users, rights and service security; or in connection with a future business reorganization, subject to applicable safeguards.'],
    ...
    terms: {
      ...
      sections: [
        ...
        ['5. Your content', 'You remain responsible for information you enter into Contivo and for having the right to use and share it. You grant Contivo the limited rights necessary to store, synchronize, display, process and export that content solely to provide and protect the service.'],
        ['6. Shared budgets and roles', 'Budget owners may invite participants and assign owner, editor or viewer permissions. A participant’s access depends on the assigned role and settings. Shared information may be changed by authorized participants. Invite only people you trust and review permissions regularly. Ownership may need to be transferred before an owner can leave or delete an account.'],
        ['7. Financial disclaimer', 'Contivo is an organization and record-keeping tool. It is not a bank, payment service, accountant, tax adviser, investment adviser or financial adviser. Calculations, statistics and reports depend on the information entered by users. You remain responsible for verifying data and making financial, tax and investment decisions.'],
        ['8. Offline operation and synchronization', 'Some features may work offline and synchronize later. Conflicts, delayed delivery or unsynchronized changes may occur because of connectivity, device state or concurrent edits. You should reconnect periodically and verify important records after synchronization.'],
        ['9. Availability and changes', 'We aim to provide a reliable service but do not guarantee uninterrupted or error-free operation. Maintenance, security work, provider outages or events outside our control may temporarily affect access. We may modify, add or discontinue features while respecting mandatory consumer rights.'],
        ['10. Fees and future paid features', 'The initial release may include free functionality. Optional subscriptions, purchases or advertising may be introduced later. Prices, billing terms and cancellation information will be shown before any purchase. Store-provider terms may also apply.'],
        ['11. Intellectual property', 'Contivo’s software, name, logo, design and website content are protected by applicable intellectual-property laws. Subject to these Terms, you receive a limited, personal, non-exclusive, non-transferable and revocable right to use the service.'],
        ['12. Account suspension and termination', 'You may stop using Contivo at any time and may request account deletion. We may restrict or suspend access where reasonably necessary to protect users or the service, investigate abuse, comply with law or address a serious breach. Where practical, we will provide notice and an opportunity to resolve the issue.'],
        ['13. Account deletion', 'Account deletion can be initiated in the app or requested through contivoapp.com/delete-account. Owners of shared objects may first need to transfer ownership or delete those objects. Deletion and retention are handled as described in the Privacy Policy.'],
    ...
    deletion: {
      eyebrow: 'Privacy', title: 'Delete your Contivo account',
    ...
    support: {
      ...
      responseItems: ['A short description of the issue', 'Your device and operating-system version', 'The Contivo app version', 'Steps that reproduce the issue', 'A screenshot without passwords or sensitive financial information'],
      responseNote: 'We aim to answer support messages as soon as possible. Response times may be longer during weekends, holidays or product launches.'
    },
    contact: {
      eyebrow: 'Contact', title: 'Let’s talk', intro: 'Questions, ideas, partnerships and feedback are welcome.',
      supportTitle: 'Product support', supportText: 'For technical questions, account issues or bug reports.',
      privacyTitle: 'Privacy', privacyText: 'For data-access, correction, portability or deletion requests.',
      websiteTitle: 'Website', websiteText: 'Official Contivo website and product updates.',
      noteTitle: 'Before sending sensitive information', noteText: 'Please do not include passwords, complete payment details or unnecessary financial information in your email.'
    }
  },
  ru: {
    common: {
      updated: 'Последнее обновление: 26 июля 2026 г.',
      back: 'На главную', contactUs: 'Связаться с нами', emailUs: 'Написать в поддержку',
      note: 'Документ применяется к мобильному приложению Contivo и сайту contivoapp.com. Если переводы отличаются, для толкования используется английская версия в пределах, разрешённых законом.'
    },
    privacy: {
      ...
      sections: [
        ...
        ['5. Совместные бюджеты', 'При участии в совместном бюджете имя профиля, роль и разрешённые действия могут быть видны другим участникам. В зависимости от прав они могут видеть операции, категории, цели, заметки, автора и изменения. Владелец управляет приглашениями и ролями. Добавляйте только людей, которым доверяете.'],
        ['6. Устройство, разрешения и уведомления', 'Для безопасности, совместимости, синхронизации и push-уведомлений могут обрабатываться версия приложения, операционная система, токен устройства и базовые диагностические события. Камера используется только по выбору пользователя для фото профиля; галерея — для выбора существующего изображения. Уведомления используются для напоминаний, приглашений и изменений в совместных бюджетах. В текущей версии Contivo не запрашивает точную геолокацию, контакты телефона или микрофон.'],
        ['7. Офлайн-хранение и синхронизация', 'Чтобы приложение работало без постоянного интернета, часть данных аккаунта, профиля, бюджетов и операций может храниться локально на устройстве. Созданные офлайн изменения ставятся в очередь и синхронизируются с облачной инфраструктурой после подключения. Удаление приложения или очистка его данных может удалить локальные изменения, которые ещё не синхронизировались.'],
        ['8. Аналитика сайта', 'На сайте contivoapp.com используется Google Analytics для понимания общей посещаемости: просмотренные страницы, примерный регион, тип устройства и источник перехода. В конфигурации сайта включена анонимизация IP. Аналитика сайта отделена от финансовых данных приложения.'],
        ['9. Цели и правовые основания', 'Данные используются для создания и защиты аккаунта; работы функций; хранения и синхронизации; офлайн-режима; совместных бюджетов, ролей и приглашений; уведомлений и служебных писем; отчётов; восстановления доступа; предотвращения злоупотреблений; устранения ошибок; поддержки; выполнения закона и повышения надёжности. В зависимости от ситуации обработка основывается на исполнении запрошенного сервиса, законном интересе в работе и защите сервиса, согласии на необязательные разрешения и выполнении юридических обязанностей.'],
        ['10. Поставщики услуг', 'Для работы Contivo используются: Supabase — авторизация, база данных, realtime-синхронизация и хранение файлов; Google Firebase Cloud Messaging — доставка push-уведомлений; Resend — служебные письма; Google Analytics — аналитика сайта. Поставщики обрабатывают данные по собственным условиям и мерам защиты и могут работать за пределами страны пользователя.'],
        ['11. Передача данных', 'Contivo не продаёт персональные данные. Они могут передаваться поставщикам только для работы сервиса; участникам совместных функций по выбору пользователя; по требованию закона или уполномоченного органа; для защиты пользователей, прав и безопасности; либо при будущей реорганизации проекта с применением необходимых гарантий.'],
    ...
    terms: {
      ...
      sections: [
        ...
        ['5. Контент пользователя', 'Пользователь отвечает за введённые данные и наличие права использовать и передавать их. Он предоставляет Contivo ограниченные права, необходимые только для хранения, синхронизации, отображения, обработки и экспорта данных в рамках работы и защиты сервиса.'],
        ['6. Совместные бюджеты и роли', 'Владелец приглашает участников и назначает роли владельца, редактора или наблюдателя. Доступ зависит от роли и настроек. Уполномоченные участники могут изменять общие данные. Приглашайте только доверенных людей и регулярно проверяйте права. Перед выходом владельца или удалением аккаунта может потребоваться передача прав.'],
        ['7. Финансовое предупреждение', 'Contivo — инструмент учёта и организации. Он не является банком, платёжным сервисом, бухгалтером, налоговым, инвестиционным или финансовым консультантом. Расчёты и отчёты зависят от данных пользователя. Пользователь самостоятельно проверяет информацию и принимает финансовые решения.'],
        ['8. Офлайн-работа и синхронизация', 'Некоторые функции работают офлайн и синхронизируются позже. Из-за соединения, состояния устройства или одновременных изменений возможны задержки и конфликты. Следует периодически подключаться к интернету и проверять важные записи после синхронизации.'],
        ['9. Доступность и изменения', 'Мы стремимся к надёжной работе, но не гарантируем отсутствие перерывов и ошибок. Обслуживание, безопасность, сбои поставщиков и события вне разумного контроля могут временно ограничить доступ. Функции могут добавляться, изменяться или прекращаться с соблюдением обязательных прав потребителей.'],
        ['10. Оплата и будущие платные функции', 'Первая версия может включать бесплатные функции. Позже могут появиться подписки, покупки или реклама. Цена, условия оплаты и отмены будут показаны до покупки. Также применяются условия магазина приложений.'],
        ['11. Интеллектуальная собственность', 'Программное обеспечение, название, логотип, дизайн и материалы Contivo защищены законом. Пользователь получает ограниченное, личное, неисключительное, непередаваемое и отзывное право пользоваться сервисом.'],
        ['12. Ограничение и прекращение доступа', 'Пользователь может прекратить использование и удалить аккаунт. Contivo может разумно ограничить доступ для защиты пользователей и сервиса, расследования злоупотреблений, выполнения закона или устранения серьёзного нарушения. По возможности будет направлено уведомление.'],
        ['13. Удаление аккаунта', 'Удаление запускается в приложении или через contivoapp.com/ru/delete-account. Владельцу совместных объектов сначала может потребоваться передать права или удалить их. Порядок удаления и хранения описан в Политике конфиденциальности.'],
    ...
    deletion: {
      eyebrow: 'Конфиденциальность', title: 'Удаление аккаунта Contivo',
    ...
    support: {
      ...
      responseItems: ['Краткое описание проблемы', 'Устройство и версию операционной системы', 'Версию приложения Contivo', 'Шаги для повторения проблемы', 'Снимок экрана без паролей и чувствительных финансовых данных'],
      responseNote: 'Мы стараемся отвечать как можно быстрее. В выходные, праздники и период запуска продукта ответ может занять больше времени.'
    },
    contact: {
      eyebrow: 'Контакты', title: 'Свяжитесь с нами', intro: 'Мы рады вопросам, идеям, предложениям о сотрудничестве и обратной связи.',
      supportTitle: 'Поддержка продукта', supportText: 'Технические вопросы, проблемы с аккаунтом и сообщения об ошибках.',
      privacyTitle: 'Конфиденциальность', privacyText: 'Запросы доступа, исправления, переноса или удаления данных.',
      websiteTitle: 'Сайт', websiteText: 'Официальный сайт Contivo и новости проекта.',
      noteTitle: 'Перед отправкой конфиденциальных данных', noteText: 'Не отправляйте пароль, полные платёжные реквизиты или ненужную финансовую информацию.'
    }
  },
  de: {
    common: {
      updated: 'Zuletzt aktualisiert: 26. Juli 2026',
      back: 'Zur Startseite', contactUs: 'Kontakt', emailUs: 'Support kontaktieren',
      note: 'Dieses Dokument gilt für die Contivo-App und die Website contivoapp.com. Bei Abweichungen zwischen Übersetzungen ist die englische Fassung maßgeblich, soweit gesetzlich zulässig.'
    },
    privacy: {
      ...
      sections: [
        ...
        ['5. Gemeinsame Budgets', 'Bei Teilnahme an einem gemeinsamen Budget können Profilidentität, Rolle und erlaubte Aktivitäten für andere Mitglieder sichtbar sein. Abhängig von Rechten können diese Buchungen, Kategorien, Ziele, Notizen, Ersteller und Änderungen sehen. Eigentümer verwalten Einladungen und Rollen. Teile Budgets nur mit vertrauenswürdigen Personen.'],
        ['6. Gerätedaten, Berechtigungen und Benachrichtigungen', 'Für Sicherheit, Kompatibilität, Synchronisierung und Push-Zustellung können App-Version, Betriebssystem, Geräte-Token und grundlegende Diagnoseereignisse verarbeitet werden. Die Kamera wird nur verwendet, wenn ein Profilfoto aufgenommen wird; die Fotomediathek nur bei Auswahl eines vorhandenen Bildes. Benachrichtigungen dienen Erinnerungen, Einladungen und Aktualisierungen gemeinsamer Budgets. Die aktuelle Version verlangt keinen Zugriff auf genauen Standort, Telefonkontakte oder Mikrofon.'],
        ['7. Offline-Speicherung und Synchronisierung', 'Für die Nutzung ohne dauerhafte Internetverbindung können ausgewählte Konto-, Profil-, Budget- und Buchungsdaten lokal auf dem Gerät gespeichert werden. Offline-Änderungen werden vorgemerkt und bei verfügbarer Verbindung synchronisiert. Das Entfernen der App oder Löschen der App-Daten kann noch nicht synchronisierte lokale Änderungen entfernen.'],
        ['8. Website-Analyse', 'contivoapp.com verwendet Google Analytics zur Auswertung der allgemeinen Websitenutzung, etwa besuchte Seiten, ungefähre Region, Gerätetyp und Verweisquelle. In der Website-Konfiguration ist IP-Anonymisierung aktiviert. Website-Analysedaten sind von den Finanzinhalten der App getrennt.'],
        ['9. Zwecke und Rechtsgrundlagen', 'Daten werden verarbeitet, um Konten zu erstellen und zu schützen, Funktionen bereitzustellen, Daten zu speichern und zu synchronisieren, Offline-Nutzung, gemeinsame Budgets, Rollen und Einladungen zu ermöglichen, Benachrichtigungen und Service-E-Mails zu senden, Berichte zu erstellen, Zugang wiederherzustellen, Missbrauch zu verhindern, Fehler zu beheben, Support zu leisten und rechtliche Pflichten zu erfüllen. Je nach Fall beruht die Verarbeitung auf Vertragserfüllung, berechtigten Interessen am sicheren Betrieb, Einwilligung für optionale Berechtigungen oder gesetzlichen Pflichten.'],
        ['10. Dienstleister', 'Contivo nutzt Supabase für Authentifizierung, Datenbank, Echtzeit-Synchronisierung und Dateispeicherung; Google Firebase Cloud Messaging für Push-Benachrichtigungen; Resend für Konto- und Service-E-Mails; Google Analytics für Website-Analyse. Diese Anbieter verarbeiten Daten nach eigenen Bedingungen und Schutzmaßnahmen und können Daten außerhalb des Wohnsitzlandes verarbeiten.'],
        ['11. Weitergabe', 'Contivo verkauft keine personenbezogenen Daten. Daten werden nur weitergegeben, soweit dies für Dienstleister zur Bereitstellung erforderlich ist, bei bewusst genutzten Gemeinschaftsfunktionen, aufgrund gesetzlicher Anordnung, zum Schutz von Nutzern und Sicherheit oder im Rahmen einer künftigen Unternehmensumstrukturierung mit geeigneten Garantien.'],
    ...
    terms: {
      ...
      sections: [
        ...
        ['5. Nutzerinhalte', 'Nutzer bleiben für eingegebene Inhalte und die erforderlichen Rechte verantwortlich. Sie räumen Contivo nur die begrenzten Rechte ein, die für Speicherung, Synchronisierung, Anzeige, Verarbeitung und Export zur Bereitstellung und Sicherung des Dienstes nötig sind.'],
        ['6. Gemeinsame Budgets und Rollen', 'Eigentümer können Teilnehmer einladen und Rollen als Eigentümer, Bearbeiter oder Beobachter vergeben. Zugriffe richten sich nach Rolle und Einstellungen. Berechtigte Teilnehmer können gemeinsame Inhalte ändern. Lade nur vertrauenswürdige Personen ein und prüfe Rechte regelmäßig. Vor Austritt oder Kontolöschung kann eine Eigentumsübertragung erforderlich sein.'],
        ['7. Finanzhinweis', 'Contivo ist ein Organisations- und Aufzeichnungstool und weder Bank, Zahlungsdienst, Buchhaltung, Steuer-, Anlage- noch Finanzberatung. Berechnungen und Berichte hängen von Nutzereingaben ab. Nutzer prüfen Informationen und treffen Entscheidungen selbst.'],
        ['8. Offline-Nutzung und Synchronisierung', 'Einige Funktionen arbeiten offline und synchronisieren später. Durch Verbindung, Gerätezustand oder gleichzeitige Bearbeitung können Verzögerungen oder Konflikte entstehen. Wichtige Daten sollten nach der Synchronisierung überprüft werden.'],
        ['9. Verfügbarkeit und Änderungen', 'Wir bemühen uns um Zuverlässigkeit, garantieren aber keinen unterbrechungs- oder fehlerfreien Betrieb. Wartung, Sicherheit, Ausfälle von Anbietern oder Ereignisse außerhalb angemessener Kontrolle können den Zugang beeinträchtigen. Funktionen können unter Beachtung zwingender Verbraucherrechte geändert werden.'],
        ['10. Entgelte und künftige Bezahlfunktionen', 'Die erste Version kann kostenlose Funktionen enthalten. Später können Abonnements, Käufe oder Werbung hinzukommen. Preise, Abrechnung und Kündigung werden vor einem Kauf angezeigt. Bedingungen des App-Stores können zusätzlich gelten.'],
        ['11. Geistiges Eigentum', 'Software, Name, Logo, Design und Website-Inhalte von Contivo sind geschützt. Nutzer erhalten ein begrenztes, persönliches, nicht ausschließliches, nicht übertragbares und widerrufliches Nutzungsrecht.'],
        ['12. Sperrung und Beendigung', 'Nutzer können die Nutzung beenden und ihr Konto löschen. Contivo kann den Zugang angemessen beschränken, um Nutzer und Dienst zu schützen, Missbrauch zu untersuchen, Gesetze einzuhalten oder schwere Verstöße zu beheben. Soweit praktikabel, wird vorher informiert.'],
        ['13. Kontolöschung', 'Die Löschung kann in der App oder über contivoapp.com/de/delete-account gestartet werden. Eigentümer gemeinsamer Objekte müssen eventuell zunächst Eigentum übertragen oder Objekte löschen. Einzelheiten stehen in der Datenschutzerklärung.'],
    ...
    deletion: {
      eyebrow: 'Datenschutz', title: 'Contivo-Konto löschen',
    ...
    support: {
      ...
      responseItems: ['Kurze Problembeschreibung', 'Gerät und Betriebssystemversion', 'Contivo-App-Version', 'Schritte zur Reproduktion', 'Screenshot ohne Passwörter oder sensible Finanzdaten'],
      responseNote: 'Wir bemühen uns um eine schnelle Antwort. An Wochenenden, Feiertagen oder während eines Produktstarts kann es länger dauern.'
    },
    contact: {
      eyebrow: 'Kontakt', title: 'Kontakt aufnehmen', intro: 'Fragen, Ideen, Partnerschaften und Feedback sind willkommen.',
      supportTitle: 'Produktsupport', supportText: 'Technische Fragen, Kontoprobleme oder Fehlermeldungen.',
      privacyTitle: 'Datenschutz', privacyText: 'Anfragen zu Auskunft, Berichtigung, Übertragbarkeit oder Löschung.',
      websiteTitle: 'Website', websiteText: 'Offizielle Contivo-Website und Projektneuigkeiten.',
      noteTitle: 'Vor dem Senden sensibler Informationen', noteText: 'Bitte sende keine Passwörter, vollständigen Zahlungsdaten oder unnötigen Finanzinformationen.'
    }
  }
};
