export const faqContent = {
  en: {
    eyebrow: 'Questions & answers', title: 'Everything you need to know',
    intro: 'Clear answers about Contivo, your data and the first app release.',
    viewAll: 'View all questions', pageTitle: 'Frequently asked questions',
    pageDescription: 'Answers about Contivo accounts, budgets, offline use, shared access, synchronization, privacy and deletion.',
    items: [
  ...
  ru: {
    eyebrow: 'Вопросы и ответы', title: 'Всё, что важно знать',
    intro: 'Понятные ответы о Contivo, данных пользователя и первой версии приложения.',
    viewAll: 'Все вопросы', pageTitle: 'Часто задаваемые вопросы',
    pageDescription: 'Ответы об аккаунте Contivo, бюджетах, офлайн-режиме, совместном доступе, синхронизации, конфиденциальности и удалении.',
    items: [
  ...
  de: {
    eyebrow: 'Fragen & Antworten', title: 'Alles, was du wissen solltest',
    intro: 'Klare Antworten zu Contivo, deinen Daten und der ersten App-Version.',
    viewAll: 'Alle Fragen ansehen', pageTitle: 'Häufig gestellte Fragen',
    pageDescription: 'Antworten zu Contivo-Konten, Budgets, Offline-Nutzung, gemeinsamem Zugriff, Synchronisierung, Datenschutz und Löschung.',
    items: [
