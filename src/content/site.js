export const site = {
  ...
  googlePlayUrl: 'https://play.google.com/store/apps/details?id=com.contivoapp.contivo',
  appStoreUrl: 'https://apps.apple.com/app/contivo-app/id6795833205',
  version: '1.0.0',
};
...
export const text = {
  ru: {
    ...
    home: {
      ...
      soonTitle: 'В разработке', soonText: 'Contivo будет постепенно расширяться. В следующих версиях планируется добавить Calendar, Tasks, темы оформления и расширенную аналитику.', soonButton: 'Новости проекта'
    },
    pages: {
      ...
      newsTitle: 'Новости', newsText: 'Новости Contivo, обновления приложения и планы дальнейшего развития проекта.', newsCardTitle: 'Contivo 1.0.0 уже доступен', newsCardDate: '10.09.2026', newsCardParagraphs: ['Первая версия Contivo сфокусирована на управлении личными и совместными финансами: бюджетах, транзакциях, финансовых целях и наглядном контроле расходов.', 'Приложение уже доступно для скачивания в App Store и Google Play.', 'В следующих версиях Contivo будет постепенно расширяться новыми возможностями.'],
